...
City words, fees/disclaimers, and required-field maps, plus a fallback
LISTINGS array used only until content/listings.json loads (or if that
fetch fails). The live, editable copy of LISTINGS lives in
content/listings.json and is managed from /admin — see app.js's
loadListingsFromCMS() and README "Editing listings". */
